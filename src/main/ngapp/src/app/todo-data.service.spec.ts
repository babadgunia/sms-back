...
describe('TodoDataService', () => {
  ...
  describe('#addTodo(todo)', () => {
	  ...
	  it('should add todos to the todos list', inject([TodoDataService], (service: TodoDataService) => {
		  let todo1 = new Todo({title: 'Hello 1', complete: false});
		  let todo2 = new Todo({title: 'Hello 2', complete: true});
  ...
  describe('#deleteTodoById(id)', () => {
	  ...
	  it('should not remove anything if todo with the corresponding id is not found', inject([TodoDataService], (service: TodoDataService) => {
		  let todo1 = new Todo({title: 'Hello 1', complete: false});
		  let todo2 = new Todo({title: 'Hello 2', complete: true});
  ...
  describe('#getTodoById(id)', () => {
	  it('should return todo by id', inject([TodoDataService], (service: TodoDataService) => {
