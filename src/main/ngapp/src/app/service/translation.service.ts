...
export class TranslationService {
	...
	get (): Promise<Map<string, Map<string, string>>> {
		...
		return this.http.get(url, {headers: TranslationService.getHeaders()}).toPromise().then(response => new JsonResponseResult(response.json()).parameters);
	}
