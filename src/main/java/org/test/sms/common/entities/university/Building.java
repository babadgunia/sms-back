...
@Entity
@SequenceGenerator(name = Building.SEQUENCE_NAME, sequenceName = Building.SEQUENCE_NAME, allocationSize = AppEntity.SEQUENCE_ALLOCATION_SIZE)
public class Building extends AppEntity {
