...
public class StudentForm extends GenericForm<Student> {
    ...
    private void initUpload() {
        upload = new UploadField() {
            ...
            protected void updateDisplay() {
                ...
                if (mimeType.equals(UIUtils.IMAGE_FORMAT_JPG) || mimeType.equals(UIUtils.IMAGE_FORMAT_JPEG) || mimeType.equals(UIUtils.IMAGE_FORMAT_PNG)) {
