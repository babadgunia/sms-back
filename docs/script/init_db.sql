...
COMMIT;
ALTER SEQUENCE user_group_seq RESTART WITH 2;
INSERT INTO application_user VALUES (1, now(), now(), 0, 'nikoloz.kvaratskhelia@helmes.ee', 'EN', 'a', '$2a$10$EebXKqyOXfoYoz6bhcXyzeTrQqd3xXsvImcuFJIdIIbky0ihQOdEi', 'ACTIVE', 'a', 1);
COMMIT;
